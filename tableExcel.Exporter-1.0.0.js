function Exportar() {
    //Chama a View com os dados que voce deseja exportar (o css deve estar inline)
    $.get("/Home/Exportar", null,
    function (data) {
        ExportarXLS(data, 'nome da worksheet', 'filename');
    }, "html")
}
...
var ExportarXLS = (function () {
    ...
    return function (html, name, filename) {       
      ...
      var ctx = { worksheet: name || 'Worksheet', table: html }    
        ...
        console.log(document.getElementById("export").href);
        document.getElementById("export").download = filename;
